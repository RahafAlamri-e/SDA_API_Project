...
//        Task 7: Retrieve the completion status of todos at indices 2, 5, and 8
        boolean statusAt2 = jsonPath.getBoolean("[2].completed");
        boolean statusAt5 = jsonPath.getBoolean("[5].completed");
        boolean statusAt8 = jsonPath.getBoolean("[8].completed");
        System.out.println("Status at index 2: " + statusAt2);
        System.out.println("Status at index 5: " + statusAt5);
        System.out.println("Status at index 8: " + statusAt8);

//        Task 8: Retrieve the title of the 10th todo
        String titleOf10th = jsonPath.getString("[9].title");
        System.out.println(titleOf10th);
